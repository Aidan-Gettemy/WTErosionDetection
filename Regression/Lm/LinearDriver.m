...
for i = 1:(numel(OutNames))
    ...
    Mdl = fitrlinear(In_train(:,Importances(i,1:20)),Out_train(:,i).Variables,...
    'OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',hyperopts);
    % loadID = OutName+"rlinear.mat";
...
function status = makeScatter(name,saveID,Predict,Actual,scores)
    ...
    title("Linear Regression: "+name, 'FontSize',20);
    set(gca,'FontSize',16);
    set(gca,'LineWidth',2);
