...
Mdl = fitcknn(In_train(:,Importances(1:20)),Out_train,...
    'OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',...
    struct('AcquisitionFunctionName','expected-improvement-plus'));

% Save the Model
save("KNN_class.mat",'Mdl');
%% Evaluate the Model
