...
Mdl = fitcecoc(In_train(:,Importances(1:5)),Out_train,...
    'OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',...
    struct('MaxTime',200));

% Save the Model
save("ECOC_class.mat",'Mdl');
%% Evaluate the Model
