...
Mdl = fitcdiscr(In_train(:,Importances(1:20)),Out_train,...
    'OptimizeHyperparameters','auto',...
    "HyperparameterOptimizationOptions",struct(...
    "AcquisitionFunctionName","expected-improvement-plus"));

% Save the Model
save("discr_class.mat",'Mdl');
%% Evaluate the Model
...
cm.Title = 'Discriminant: Training';
cm.FontSize = 20;
...
title("Discriminant: ROC Training")
fontsize(16,"points")
...
xlabel("False Positive Rate")
ylabel("True Positive Rate")
title("Discriminant: ROC Testing")
fontsize(16,"points")
legend(lgd,'Location','eastoutside')
colormap(turbo(n))
cb = colorbar;
